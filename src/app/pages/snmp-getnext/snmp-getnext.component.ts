...
@Component({
  selector: 'app-snmp-getnext',
  templateUrl: './snmp-getnext.component.html',
  styles: []
})
export class SnmpGetnextComponent implements OnInit {
  ...
  sendSNMP(f: NgForm) {
    ...
    this._snmpService.getNextSNMP(this.snmpMessage)
          .subscribe(respuesta => {
            if(respuesta){
